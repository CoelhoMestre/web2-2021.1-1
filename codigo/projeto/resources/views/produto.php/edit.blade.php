    ...
    <form action="{{route('produtos.update')}}" method="post">
        ...
        <div class="row">
            ...
            <label for="idreferencia" class="form-label black-text">Referência</label>
                <input type="text" id="idreferencia" name="referencia" oninput="validaInput(this, true)"  class="form-control" maxlength="20" value="{{$produto->referencia}}" required>
                @error('idreferencia')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div>
            ...
            <label for="unidade" class="form-label black-text">Unidade</label>
                <input type="text" id="unidade" name="unidade" oninput="validaInput(this, false)" class="form-control" maxlength="2"  value="{{$produto->unidade}}"required>
                @error('unidade')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div> 
