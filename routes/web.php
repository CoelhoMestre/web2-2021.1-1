...
Route::delete('/entradas/{id}', [EntradaController::class, 'destroy'])->name('entradas.delete');
...
Route::delete('/itensentradas/{id}', [ItensEntradasController::class, 'destroy'])->name('itensentrada.delete');
...
Route::delete('/itensvendas/{id}', [ItensVendasController::class, 'destroy'])->name('itensvenda.delete');